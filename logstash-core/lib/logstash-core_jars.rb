...
begin
  ...
  require 'com/fasterxml/jackson/core/jackson-annotations/2.7.4/jackson-annotations-2.7.4.jar'
...
if defined? Jars
  ...
  require_jar( 'com.fasterxml.jackson.core', 'jackson-annotations', '2.7.4' )
