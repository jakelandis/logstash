...
public class ReloadWitnessTest {
    ...
    public void testSerializeEmpty() throws Exception {
        ...
        assertThat(json).isEqualTo("{\"reloads\":{\"last_error\":{},\"last_success_timestamp\":null,\"last_failure_timestamp\":null}}");
    }
    ...
    public void testSerializeSuccess() throws Exception {
        ...
        witness.lastSuccessTimestamp(rubyTimestamp);
        String json = witness.asJson();
        assertThat(json).isEqualTo("{\"reloads\":{\"last_error\":{},\"successes\":1,\"last_success_timestamp\":\""
                + timestamp.toIso8601() + "\"," + "\"last_failure_timestamp\":null}}");
    }
    ...
    public void testSerializeFailure() throws Exception {
        ...
        witness.lastFailureTimestamp(rubyTimestamp);
        String json = witness.asJson();
        assertThat(json).isEqualTo("{\"reloads\":{\"last_error\":{},\"last_success_timestamp\":null,\"last_failure_timestamp\":\""
