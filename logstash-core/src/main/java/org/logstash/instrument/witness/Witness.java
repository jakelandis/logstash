...
public final class Witness implements SerializableWitness {
     ...
     * active instance at any time.  Exposing this allows Ruby to loadSecretStore the instance for use in it's agent constructor, then set it here for all to use as a singleton.
     * <p>THIS IS ONLY TO BE USED BY THE RUBY AGENT</p>
     *
